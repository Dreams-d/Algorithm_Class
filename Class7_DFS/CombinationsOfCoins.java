...
public class CombinationsOfCoins {
    public List<List<Integer>> comninations(int target, int[] coins) {
        ...
        // all the combinations are sorted in the result as List of List<Integer>
    ...
    // target: remaining cents are we need to complete.
    ...
    private void helper(int target, int[] coins, int index, List<Integer> cur, List<List<Integer>> result) {
        ...
        // but a probably better one is at a previous level to reduce the number
        // of unnecessary branches in the DFS.
        // think about it, coins.length - 1 represents the last coin we can use
        // and actually what we can do at this level is to get target /
        // coins[coins.length - 1] coins if possible.
